...
class Program
{
    ...
    static string filePath = "C:\\Users\\Lenovo\\Desktop\\project lab 7\\lab7zad1.csv";
    ...
    static void ModyfikujOsobe()
    {
        ...
        {
            Console.WriteLine( $"Znalezono osobę: {ModyfikacjaOsoby.Imie} {ModyfikacjaOsoby.Nazwisko}");
